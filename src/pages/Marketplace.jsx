  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      {featured && category === 'All' && (
        <div className="mb-10 rounded-2xl overflow-hidden flex flex-col md:flex-row group border border-primary/10 hover:border-primary/20 transition-colors" style={{ background: '#e3eff7' }}>
          <div className="md:w-1/2 h-56 md:h-72 flex items-center justify-center overflow-hidden" style={{ background: '#e3eff7' }}>
            <img
